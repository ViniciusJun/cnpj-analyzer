...
public class DashboardData {
    ...
    public String getClassificacaoSucesso() { return classificacaoSucesso; }
    public void setClassificacaoSucesso(String classificacaoSucesso) { this.classificacaoSucesso = classificacaoSucesso; }
